<script lang="ts">
     ...
     function handleFileSelect(e: Event) {
          ...
          if (target.files) {
               ...
               console.log("Files selected via browse:", selectedFiles);
          }
     }
...
<ComponentCard title="Dropzone">
     <div class="transition border border-gray-300 border-dashed cursor-pointer dark:hover:border-brand-500 dark:border-gray-700 rounded-xl hover:border-brand-500">
          <div
               ...
               ondrop={handleDrop}
               class="dropzone rounded-xl border-dashed border-gray-300 p-7 lg:p-10 transition-colors
               {isDragActive 
          ...
          >
               ...
               <div class="dz-message flex flex-col items-center m-0!">
                    <div class="mb-5.5 flex justify-center">
                         <div class="flex h-17 w-17 items-center justify-center rounded-full bg-gray-200 text-gray-700 dark:bg-gray-800 dark:text-gray-400">
