<script lang="ts">
     ...
     import ThemeToggleButton from "$components/common/ThemeToggleButton.svelte";
     import NotificationDropdown from "$components/header/NotificationDropdown.svelte";
...
<header class="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
     <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
          <div class="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
               ...
               <a href={resolve('/')} class="lg:hidden">
                    <img width="154" height="32" class="dark:hidden" src="/images/logo/logo.svg" alt="Logo" />
                    <img width="154" height="32" class="hidden dark:block" src="/images/logo/logo-dark.svg" alt="Logo" />
               </a>
                    ...
                    <form onsubmit={(e) => e.preventDefault()}>
                         <div class="relative">
                              ...
                              <input
                                   ...
                                   class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-none focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 xl:w-107.5"
                              />
                              <button class="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-1.75 py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 dark:border-gray-800 dark:bg-white/3 dark:text-gray-400">
                                   <span> ⌘ </span>
                                   <span> K </span>
                              </button>
                         </div>
