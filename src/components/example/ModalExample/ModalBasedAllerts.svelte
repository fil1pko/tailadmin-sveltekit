...
<ComponentCard title="Modal Based Alerts">
     ...
     >
          <div class="text-center">
               ...
               <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90 sm:text-title-sm">Well Done!</h4>
               <p class="text-sm leading-6 text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur. Feugiat ipsum libero tempor felis risus nisi non.</p>
               <div class="flex items-center justify-center w-full gap-3 mt-7">
                    <button onclick={() => successOpen = false} type="button" class="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-success-500 shadow-theme-xs hover:bg-success-600 sm:w-auto">
                         Okay, Got It
                    </button>
               </div>
          </div>
     ...
     <Modal isOpen={infoOpen} onClose={() => infoOpen = false} className="max-w-150 p-5 lg:p-10">
          <div class="text-center">
               <div class="relative flex items-center justify-center z-1 mb-7">
               ...
               <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90 sm:text-title-sm">Information Alert!</h4>
               <p class="text-sm leading-6 text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur. Feugiat ipsum libero tempor felis risus nisi non.</p>
               <div class="flex items-center justify-center w-full gap-3 mt-7">
                    <button onclick={() => infoOpen = false} type="button" class="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-blue-light-500 shadow-theme-xs hover:bg-blue-light-600 sm:w-auto">
                         Okay, Got It
                    </button>
               </div>
          </div>
     ...
     <Modal isOpen={warningOpen} onClose={() => warningOpen = false} className="max-w-150 p-5 lg:p-10">
          <div class="text-center">
               <div class="relative flex items-center justify-center z-1 mb-7">
     ...
     <Modal isOpen={errorOpen} onClose={() => errorOpen = false} className="max-w-150 p-5 lg:p-10">
          <div class="text-center">
               <div class="relative flex items-center justify-center z-1 mb-7">
               ...
               <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90 sm:text-title-sm">Danger Alert!</h4>
               <p class="text-sm leading-6 text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur. Feugiat ipsum libero tempor felis risus nisi non.</p>
               <div class="flex items-center justify-center w-full gap-3 mt-7">
                    <button onclick={() => errorOpen = false} type="button" class="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-error-500 shadow-theme-xs hover:bg-error-600 sm:w-auto">
                         Okay, Got It
                    </button>
               </div>
          </div>
