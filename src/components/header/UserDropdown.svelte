...
<div class="relative">
     ...
     >
          ...
          <svg class="stroke-gray-500 dark:stroke-gray-400 transition-transform duration-200 {isOpen ? 'rotate-180' : ''}" width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
