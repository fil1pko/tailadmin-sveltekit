...
<div class="rounded-2xl border border-gray-200 bg-white px-5 pb-5 pt-5 dark:border-gray-800 dark:bg-white/3 sm:px-6 sm:pt-6">
     ...
     <div class="max-w-full overflow-x-auto custom-scrollbar">
          <div class="min-w-250 xl:min-w-full">
